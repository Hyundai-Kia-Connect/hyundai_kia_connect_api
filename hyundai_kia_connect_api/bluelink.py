...
def print_vehicle(vehicle):
  ...
  print("  total_driving_range:", vehicle.total_driving_range, vehicle.total_driving_range_unit)
  ...
  print("  tire_pressure_rear_left_warning_is_on:", vehicle.tire_pressure_rear_left_warning_is_on)
  print("  tire_pressure_front_left_warning_is_on:", vehicle.tire_pressure_front_left_warning_is_on)
  print("  tire_pressure_front_right_warning_is_on:", vehicle.tire_pressure_front_right_warning_is_on)
  print("  tire_pressure_rear_right_warning_is_on:", vehicle.tire_pressure_rear_right_warning_is_on)
  print("Service")
  print("  next_service_distance:", vehicle.next_service_distance, vehicle._next_service_distance_unit)
  print("  last_service_distance:", vehicle.last_service_distance, vehicle._last_service_distance_unit)
  print("Location")
  ...
  print("  estimated_current_charge_duration:", vehicle.ev_estimated_current_charge_duration, vehicle._ev_estimated_current_charge_duration_unit)
  print("  estimated_fast_charge_duration:", vehicle.ev_estimated_fast_charge_duration, vehicle._ev_estimated_fast_charge_duration_unit)
  print("  estimated_portable_charge_duration:", vehicle.ev_estimated_portable_charge_duration, vehicle._ev_estimated_portable_charge_duration_unit)
  print("  estimated_station_charge_duration:", vehicle.ev_estimated_station_charge_duration, vehicle._ev_estimated_station_charge_duration_unit)
  print("  target_range_charge_AC:", vehicle.ev_target_range_charge_AC, vehicle._ev_target_range_charge_AC_unit)
  print("  target_range_charge_DC:", vehicle.ev_target_range_charge_DC, vehicle._ev_target_range_charge_DC_unit)

  print("  first_departure_enabled:", vehicle.ev_first_departure_enabled)
  print("  first_departure_climate_temperature:", vehicle.ev_first_departure_climate_temperature, vehicle._ev_first_departure_climate_temperature_unit)
  print("  first_departure_days:", vehicle.ev_first_departure_days)
  print("  first_departure_time:", vehicle.ev_first_departure_time)
  print("  first_departure_climate_enabled:", vehicle.ev_first_departure_climate_enabled)
  print("  first_departure_climate_defrost:", vehicle.ev_first_departure_climate_defrost)
  print("  second_departure_enabled:", vehicle.ev_second_departure_enabled)
  print("  second_departure_climate_temperature:", vehicle.ev_second_departure_climate_temperature, vehicle._ev_second_departure_climate_temperature_unit)
  print("  second_departure_days:", vehicle.ev_second_departure_days)
  print("  second_departure_time:", vehicle.ev_second_departure_time)
  print("  second_departure_climate_enabled:", vehicle.ev_second_departure_climate_enabled)
  print("  second_departure_climate_defrost:", vehicle.ev_second_departure_climate_defrost)
  ...
  print("PHEV/HEV/IC")
  print("  fuel_driving_range:", vehicle.fuel_driving_range, vehicle._fuel_driving_range_unit)
...
def main():
  ...
  parser.add_argument(
      "--region", default=os.environ.get("BLUELINK_REGION", const.REGION_CANADA),
      choices=sorted(const.REGIONS.values()),
      help="Car's region, use env var BLUELINK_REGION")
  parser.add_argument(
      "--brand", default=os.environ.get("BLUELINK_BRAND", const.BRAND_HYUNDAI),
  ...
  parser_info = subparsers.add_parser("info", help="Prints infos about the cars found")
  parser_info.set_defaults(func=cmd_info)
  parser_info.add_argument(
      "--json", type=argparse.FileType("w", encoding="UTF-8"),
  ...
  vm = hyundai_kia_connect_api.VehicleManager(
      region=region, brand=brand, username=args.username,
      password=args.password, pin=args.pin, geocode_api_enable=true,
